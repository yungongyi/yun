	...
	//页码信息
	var tempStr = "共"+countTotal+"条数据      共"+countPage+"页  当前第"+currentPage+"页";
	//换页链接显示控制
	if(currentPage>1){
		tempStr += "<span style='float:right;'><a id=\"firstpage\" href=\"javascript:void(0)\">首页</a>";
		tempStr += "<a id=\"prevpage\"  href=\"javascript:void(0)\" ><上一页</a>";
	}else{
		tempStr += "<span style='float:right'>首页";
		tempStr += "<上一页";    
	}
