...
public class LoginController {
	...
	//用户注册
		...
		public String savePerson(@RequestParam("name")String name ,@RequestParam("phone")String iphone,@RequestParam("password")String password  , @RequestParam("yanzhengma")String yanzhengma,HttpSession session,HttpServletRequest request) { 
