...
//加载喇叭
function loadHorn(){
    $("body").append('<img id="horn" src="/commonweal/static/horn/horn.png" style="width:5em;position: fixed;left: 2%;bottom: 3em;z-index: 9999"/>'
        +'<div style="z-index:999;border-radius: 8px;position:fixed;background-color: black;opacity: 0;width:70%;height: 3em;left: 15%;top:10%;">'
        +'<p id="horn_text" style="border-radius: 8px;'
